  ...
  <div class="container-app py-8">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <NuxtLink
        ...
        class="glass-card p-6 group hover:border-slate-600 transition-all duration-300"
      >
        <div class="flex items-start gap-4">
          <!-- Icon -->
          <div class="w-16 h-16 rounded-xl bg-gradient-to-br from-red-600/20 to-orange-600/20 flex items-center justify-center flex-shrink-0 group-hover:from-red-600/30 group-hover:to-orange-600/30 transition-all">
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center justify-between gap-2 mb-2">
              <h2 class="text-xl font-semibold text-slate-100 group-hover:text-white transition-colors">
                {{ category.name }}
              </h2>
              <span class="text-sm text-slate-400 bg-slate-800 px-2 py-1 rounded-full">
            ...
            <!-- View Link -->
            <div class="mt-4 flex items-center gap-1 text-red-400 text-sm font-medium group-hover:text-red-300 transition-colors">
